...
namespace CMS.Web.Controllers.Export
{
    ...
    public class ExportCore2<T>
    {
        ...
        public int HeaderHeight { get; set; }
        public ExportCore2(int headerHeight =2)
        {
        ...
        private string GetStringResultByArr(dynamic lstObj, string[] arr, int index)
        {
            ...
            foreach (Object obx in lstObj)
            {
                ...
                if (ob.GetType().Name == "String" ||  ob.GetType().Name == "Int32" || ob.GetType().Name == "Double" || ob.GetType().Name == "bool")
                {
        ...
        private string GetValueByPName(Object obj, string eh)
        {
            ...
            if (typeName == "String" || typeName == "Int32" || typeName == "Double" || typeName == "DateTime" || typeName == "bool")
            {
        ...
        {
            Worksheet.SelectedRange[HeaderInput.HeaderHeight, 1, HeaderInput.HeaderHeight + HeaderHeight, LstProperTies.Count].Value = ExcelValuesResult;
